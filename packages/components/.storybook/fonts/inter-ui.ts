...
export const InterUi = css`
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 100;
        src: url("../fonts/inter-ui/Inter-UI-ThinItalic-BETA.woff2")
                format("woff2"),
            url("../fonts/inter-ui/Inter-UI-ThinItalic-BETA.woff")
                format("woff");
    }
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 200;
        src: url("../fonts/inter-ui/Inter-UI-ExtraLight-BETA.woff2")
                format("woff2"),
            url("../fonts/inter-ui/Inter-UI-ExtraLight-BETA.woff")
                format("woff");
    }
    @font-face {
        font-family: "Inter UI";
        font-style: italic;
        font-weight: 200;
        src: url("../fonts/inter-ui/Inter-UI-ExtraLightItalic-BETA.woff2")
                format("woff2"),
            url("../fonts/inter-ui/Inter-UI-ExtraLightItalic-BETA.woff")
                format("woff");
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 300;
        src: url("../fonts/inter-ui/Inter-UI-LightItalic-BETA.woff2")
                format("woff2"),
            url("../fonts/inter-ui/Inter-UI-LightItalic-BETA.woff")
                format("woff");
    }
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 500;
        src: url("../fonts/inter-ui/Inter-UI-MediumItalic.woff2")
                format("woff2"),
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 600;
        src: url("../fonts/inter-ui/Inter-UI-SemiBoldItalic.woff2")
                format("woff2"),
    ...
    @font-face {
        ...
        font-style: italic;
        font-weight: 800;
        src: url("../fonts/inter-ui/Inter-UI-ExtraBoldItalic.woff2")
                format("woff2"),
            url("../fonts/inter-ui/Inter-UI-ExtraBoldItalic.woff")
                format("woff");
    }
