...
var Input = forwardRef(function (_a, ref) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(StyledInput, __assign({ type: type, disabled: disabled, ref: ref, className: classnames(className, "form-control"), id: id, name: name, onChange: onChange, onClick: onClick, onBlur: onBlur, value: value, readOnly: readonly, "$state": state, "$showState": showState, "$showErrorOnly": showErrorOnly, "$width": width, "$height": height, "$customStyle": customStyle }, restProps), void 0),
