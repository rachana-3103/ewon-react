...
export declare const StyledBody: import("styled-components").StyledComponent<({ px, py, p, pt, pb, pl, pr, ...rest }: any) => JSX.Element, any, SpaceProps<Required<import("styled-system").Theme<import("react").ReactText>>, string | number | symbol>, never>;
