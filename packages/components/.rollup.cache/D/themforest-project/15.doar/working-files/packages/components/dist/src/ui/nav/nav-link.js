...
export var NavLink = function (_a) {
    ...
    return (_jsx(StyledNavLink, __assign({ className: classnames(className, "nav-link", active && "active"), path: path, "$active": active, onClick: onClick, "$customStyle": customStyle, "$iconPosition": iconPosition, "$iconDistance": iconDistance, rel: rel, target: target, "aria-label": label }, rest, { children: children }), void 0));
};
