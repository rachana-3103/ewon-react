...
var DataTable = function (_a) {
    ...
    return (_jsx(ReactDataTable, { theme: theme === "dark" ? "solarizedDark" : "solarized", columns: columns, data: data, customStyles: customStyles, paginationPerPage: paginationPerPage, paginationRowsPerPageOptions: paginationRowsPerPageOptions, pagination: pagination }, void 0));
};
