...
var CardImage = function (_a) {
    ...
    return (_jsx(StyledCardImage, __assign({ src: src, alt: alt, className: classnames(className, "card-image", topClass, bottomClass), "$isTop": isTop, "$isBottom": isBottom }, restProps), void 0));
};
