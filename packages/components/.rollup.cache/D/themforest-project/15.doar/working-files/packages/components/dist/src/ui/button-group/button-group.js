...
var ButtonGroup = function (_a) {
    ...
    return (_jsx(StyledGroup, __assign({ role: "group", "$size": size, "$vertical": vertical, "aria-label": label, className: classnames(className, "btn-group") }, restProps, { children: children }), void 0));
};
