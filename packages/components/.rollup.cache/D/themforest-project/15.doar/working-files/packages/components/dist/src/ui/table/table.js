...
var Table = function (_a) {
    ...
    return (_jsx(StyledTableResponsive, { children: _jsx(StyledTable, __assign({ className: classNames(className), "$theadColor": theadColor, "$striped": striped, "$bordered": bordered, "$hover": hover, "$compact": compact, "$color": color, "$borderless": borderless }, restProps, { children: children }), void 0) }, void 0));
};
