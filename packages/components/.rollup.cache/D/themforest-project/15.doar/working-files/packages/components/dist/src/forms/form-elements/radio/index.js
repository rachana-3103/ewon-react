...
var Radio = forwardRef(function (_a, ref) {
    ...
    return (_jsxs(StyledBoxWrap, __assign({ className: classnames(className, "custom-radio") }, restProps, { children: [_jsx(StyledRadio, { type: "radio", disabled: disabled, id: id, name: name, checked: checked, value: value, onChange: onChange, onClick: onClick, onBlur: onBlur, ref: ref }, void 0),
            _jsx(StyledRadioLabel, __assign({ htmlFor: id }, { children: label }), void 0),
