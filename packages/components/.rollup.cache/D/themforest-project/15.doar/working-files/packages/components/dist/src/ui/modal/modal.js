...
var Modal = function (_a) {
    ...
    return (_jsx(Portal, { children: _jsxs(_Fragment, { children: [_jsx(StyledBackdrop, { "$show": show }, void 0),
                _jsx(StyledModal, __assign({ "$show": show, "$size": size, "$centered": centered, className: classnames(className), onClick: onClose }, restProps, { children: _jsx(CSSTransition, __assign({ in: show, timeout: 400, unmountOnExit: true, classNames: "modal" }, { children: function () { return (_jsx("div", __assign({ className: "modal-dialog" }, { children: _jsx("div", __assign({ className: "modal-content", onClick: function (e) { return e.stopPropagation(); }, role: "button", tabIndex: 0 }, { children: children }), void 0) }), void 0)); } }), void 0) }), void 0)] }, void 0) }, void 0));
};
Modal.defaultProps = {
    size: "md",
    centered: true,
