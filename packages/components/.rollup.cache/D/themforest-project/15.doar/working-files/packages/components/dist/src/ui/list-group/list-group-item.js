...
var ListGroupItem = function (_a) {
    ...
    return (_jsx(StyledListGroupItem, __assign({ as: as, className: classnames(className, "list-group-item"), "$active": active, "$disabled": disabled, "$action": action, href: href, "$flush": flush, "$horizontal": horizontal }, restProps, { children: children }), void 0));
};
