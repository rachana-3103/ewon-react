...
export declare const StyledMediaBody: import("styled-components").StyledComponent<({ width, m, mr, ml, mt, mb, px, ...props }: any) => JSX.Element, any, SpaceProps<Required<import("styled-system").Theme<import("react").ReactText>>, string | number | symbol>, never>;
export {};
