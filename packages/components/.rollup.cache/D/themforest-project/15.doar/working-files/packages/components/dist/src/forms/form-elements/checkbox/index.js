...
var Checkbox = forwardRef(function (_a, ref) {
    ...
    return (_jsxs(StyledBoxWrap, __assign({ className: classnames(className, "custom-checkbox") }, restProps, { children: [_jsx(StyledCheckbox, { type: "checkbox", disabled: disabled, id: id, name: name, checked: checked, onChange: onChange, onClick: onClick, onBlur: onBlur, value: value, ref: ref }, void 0),
            _jsx(StyledCheckboxLabel, __assign({ htmlFor: id }, { children: label }), void 0),
            feedbackText && (_jsx(Feedback, __assign({ state: state }, { children: feedbackText }), void 0))] }), void 0));
});
