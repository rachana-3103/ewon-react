...
export declare const StyledInputGroup: import("styled-components").StyledComponent<({ mb, ...rest }: any) => JSX.Element, any, SpaceProps<Required<import("styled-system").Theme<import("react").ReactText>>, string | number | symbol>, never>;
